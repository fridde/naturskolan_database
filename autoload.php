<?php
    ...
    function getSettings($globalize = true, $file = 'settings.toml', $prefix = "")
    {
        $settings = false;
...
{
    throw new \Exception("The function getIncludables is no longer implemented. Change to composer package system.");
